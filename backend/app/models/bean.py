...
class Bean(Base):
    ...
    processing_method: Mapped[ProcessingMethod | None] = mapped_column(Enum(ProcessingMethod))
    roast_level: Mapped[RoastLevel | None] = mapped_column(Enum(RoastLevel))
    tasting_notes_raw: Mapped[str | None] = mapped_column(Text)
